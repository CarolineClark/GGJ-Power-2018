...
IMAGE_DIR = "images"
RIGHT_IMAGE_FILE = os.path.join(IMAGE_DIR, "Melody/right.png")
UP_IMAGE_FILE = os.path.join(IMAGE_DIR, "Melody/top.png")
# DOWN_IMAGE_FILE = os.path.join(IMAGE_DIR, "little-red/top.png")
# LEFT_IMAGE_FILE = os.path.join(IMAGE_DIR, "zombies/zombie-left-lit.png")
NORMAL_MAP_FILE_NAME = os.path.join(IMAGE_DIR, "Melody/normal-map.png")
...
def get_blue_data():
    ...
    # blue_data = average_blue_data(data_up, data_right)
    blue_data = pure_blue(data_up)
    return blue_data
